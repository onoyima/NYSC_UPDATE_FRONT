  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 sm:py-6">
            <div className="flex items-center space-x-3 sm:space-x-4 mb-4 sm:mb-0">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl font-bold text-gray-900">NYSC Data Portal</h1>
            ...
            <div className="mb-6 lg:mb-8">
              <div className="relative max-w-full sm:max-w-md">
                ...
                <input
                  ...
                  className="block w-full pl-9 sm:pl-10 pr-3 py-2.5 sm:py-3 border border-gray-300 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 shadow-sm hover:shadow-md text-sm sm:text-base"
                />
              </div>
              {search && (
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <a
          href="https://wa.me/2348123456789?text=Hello,%20I%20need%20help%20with%20my%20NYSC%20data"
          target="_blank"
          rel="noopener noreferrer"
